  ...
  return (
    <div className="min-h-screen bg-parchment text-text-1">
      ...
      <main className="relative z-10 overflow-x-clip bg-blue-neutral
        ...
        <div id="projects">
          <h2 className="font-heading font-medium text-text-1 text-3xl sm:text-4xl md:text-5xl lg:text-7xl text-center mb-6 sm:mb-10 md:mb-14 pt-10 sm:pt-12 md:pt-20">
